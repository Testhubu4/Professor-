...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002024195136').split()]
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://testhubu494:test08@cluster0.nxa1umi.mongodb.net/?retryWrites=true&w=majority")
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Hub4u_discussion')
