...
I Cᴀɴ Pʀᴏᴠɪᴅᴇ Mᴏᴠɪᴇ Fᴏʀ Yᴏᴜ Jᴜsᴛ Aᴅᴅ Mᴇ Iɴ Yᴏᴜʀ Gʀᴏᴜᴘ Oʀ Jᴏɪɴ Oᴜʀ Gʀᴏᴜᴘ</b>"""
    ...
    ABOUT_TXT = """<b>✯ Mʏ ɴᴀᴍᴇ: {}
✯ Dᴇᴠᴇʟᴏᴩᴇʀ: <a herf=https://t.me/hub4u_updates>ᴍʀ.Hub4u ᴛɢ</a>
...
✯ Mʏ Vᴇʀꜱɪᴏɴ: ᴩʀᴏꜰᴇꜱꜱᴏʀ-ʙᴏᴛ ᴠ4.5.0</b>"""
    ...
    SOURCE_TXT = """<b>NOTE:</b>
- ꜱᴏᴜʀᴄᴇ ᴄᴏᴅᴇ ʜᴇʀᴇ ◉› :<a href=https://t.me/RockyDadaa>𝐏𝐑𝐎𝐅𝐄𝐒𝐒𝐎𝐑-𝐁𝐎𝐓</a>

<b>ᴅᴇᴠ: <a herf=https://t.me/hub4u_updates>ᴍʀ.HUB4U ᴛɢ</a></b>"""
...
Fʀᴇᴇ Dɪꜱᴋ: {}"""
    ...
    FORCE_SUB_TEXT = "**You are not in our channel given below so you don't get the Webseries file...\n\nIf you want the Webseries file, click on the '🍿ᴊᴏɪɴ ᴏᴜʀ ʙᴀᴄᴋ-ᴜᴘ ᴄʜᴀɴɴᴇʟ🍿' button below and join our back-up channel, then click on the '🔄 Try Again' button below...\n\nThen you will get the Webseries files...\n\n\nआप नीचे दिए गए हमारे चैनल में नहीं हैं इसलिए आपको वेबसेरिएस फ़ाइल नहीं मिलेगी...\n\nअगर आपको वेबसेरिएस फ़ाइल चाहिए तो नीचे दिए गए '🍿ᴊᴏɪɴ ᴏᴜʀ ʙᴀᴄᴋ-ᴜᴘ ᴄʜᴀɴɴᴇʟ🍿' बटन पर क्लिक करें और हमारे बैक-अप चैनल से जुड़ें, फिर नीचे दिए गए '🔄 Try Again' बटन पर क्लिक करें\n\nफिर आपको वेबसेरिएस फ़ाइलें मिल जाएँगी...**"
   
    WELCOM_TEXT = """Hᴇʏ {user} 💞

Wᴇʟᴄᴏᴍᴇ ᴛᴏ {chat}.

ꜱʜᴀʀᴇ & ꜱᴜᴩᴩᴏʀᴛ, ʀᴇqᴜᴇꜱᴛ ʏᴏᴜ ᴡᴀɴᴛᴇᴅ Webseries"""
