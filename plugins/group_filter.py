...
async def advantage_spoll_choker(bot, query):
    ...
    await query.answer('Checking for Webseries in database...')
    ...
    if k == False:
        ...
        if files:
            ...
            k = await query.message.edit('This Webseries Not Found In DataBase')
...
async def advantage_spell_chok(msg):
    ...
    gs_parsed = []
    if not g_s:
        k = await msg.reply("I Cᴏᴜʟᴅɴ'ᴛ Fɪɴᴅ Aɴʏ Webseries Iɴ Tʜᴀᴛ Nᴀᴍᴇ")
